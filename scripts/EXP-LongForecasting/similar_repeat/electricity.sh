...
###
 # @Author: 
 # @Date: 2023-08-14 14:40:38
 # @LastEditors: peiqi yu
 # @LastEditTime: 2023-08-14 14:41:04
 # @FilePath: /ubuntu/projects/LTSF-Linear/scripts/EXP-LongForecasting/similar_repeat/electricity.sh
### 
if [ ! -d "./logs" ]; then
    mkdir ./logs
fi
